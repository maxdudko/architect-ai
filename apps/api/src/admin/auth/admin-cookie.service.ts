...
export const ADMIN_REFRESH_TOKEN_COOKIE = 'architect_admin_refresh_token';
...
export class AdminCookieService {
  ...
  clearRefreshTokenCookie(response: Response): void {
    response.clearCookie(ADMIN_REFRESH_TOKEN_COOKIE, this.getCookieOptions());
  }
  ...
  private getRefreshTtlMs(): number {
    const ttl =
      this.configService.get<string>('JWT_ADMIN_REFRESH_TTL') ??
